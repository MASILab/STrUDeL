...
* **The STrUDeL paper:** [Leon Y. Cai](mailto:leon.y.cai@vanderbilt.edu), Ho Hin Lee, Nancy R. Newlin, Michael E. Kim, Daniel Moyer, Francois Rheault, Kurt G. Schilling, and Bennett A. Landman. Implementation considerations for deep learning with diffusion MRI streamline tractography. *In Submission*. 2023.
