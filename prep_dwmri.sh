...
# echo "prep_dwmri.sh: Generating probablistic tractogram (with ACT)..."
# tckgen $in_dir/dwmri_fod.nii.gz $in_dir/dwmri_prob50to250.tck  -algorithm iFOD2 -select 1000000 -step 1 -seed_image $in_dir/dwmri_seed.nii.gz -mask $in_dir/dwmri_mask.nii.gz -minlength 50 -maxlength 250 -act $in_dir/dwmri_5tt.nii.gz -nthreads 1
...
# scil_apply_transform_to_tractogram.py --reference $in_dir/dwmri_b0.nii.gz $in_dir/dwmri_prob50to250.tck $in_dir/T1_N4.nii.gz $in_dir/dwmri2T1_0GenericAffine.mat $in_dir/T1_prob50to250.trk --inverse --remove_invalid 
...
# scil_apply_transform_to_tractogram.py $in_dir/T1_prob50to250.trk $in_dir/T1_N4_mni_2mm.nii.gz $in_dir/T12mni_0GenericAffine.mat $in_dir/T1_prob50to250_mni_2mm.trk --inverse --remove_invalid 
...
# scil_compute_streamlines_density_map.py $in_dir/T1_prob50to250_mni_2mm.trk $in_dir/T1_prob50to250_mni_2mm_tdi.nii.gz
